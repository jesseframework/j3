...
class _LoginFormState extends State<LoginForm> {
  ...
  Widget build(BuildContext context) {
    _onLoginButtonPressed() {
      BlocProvider.of<ChecknetworkconnectionBloc>(context)
    ...
    return BlocListener<ChecknetworkconnectionBloc,
            ChecknetworkconnectionState>(
        listener: (context, state) {
          if (state is NoInternetState) {
            Scaffold.of(context)
                .showSnackBar(new SnackBar(content: new Text("no internet")));
          }
        },
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Expanded(
                              child: TextFromFieldEmailReusable(
